...
export default function DashboardLayout({ children }) {
  const { userData, features } = useCartContext();
                ...
                <li className="nav-item dropdown hidden-caret">
                  <div className="dropdown">
                    ...
                    <ul className="dropdown-menu">
                      <li><Link className="dropdown-item" to="/parametres-du-stockiste">Boutique</Link></li>
                      <li><Link className="dropdown-item" to="/parametres-du-stockiste">Paramètres</Link></li>
          ...
          <div className="sidebar-wrapper scrollbar scrollbar-inner">
            <div className="sidebar-content">
              ...
              <ul className="nav nav-primary">
                <li className={`nav-item ${urlActuelle === '/store-manager' ? 'active' : ''}`}>
                  <Link
                    to="/store-manager"
                    className="collapsed"
                  >
                ...
                <li className={`nav-item ${urlActuelle === '/user/gestion-stock' ? 'active' : ''}`}>
                  <Link to="/user/gestion-stock">
                    <i className="fas fa-th-list" />
                    <p>Gestion des stocks</p>
                  </Link>
                </li>
                <li className={`nav-item ${urlActuelle === '/user/apparence-themes' ? 'active' : ''}`}>
                  <Link to="/user/apparence-themes">
                    <i className="fas fa-pen-square" />
                    <p>Apparence et thèmes</p>
                  </Link>
                </li>
                <li className={`nav-item ${urlActuelle === '/user/docs' ? 'active' : ''}`}>
                  <Link to="/user/docs">
                    <i className="fas fa-table" />
                    <p>Documents</p>
                  </Link>
                </li>
                <li className={`nav-item ${urlActuelle === '/user/messages' ? 'active' : ''}`}>
                  <Link to="/user/messages">
                    <i className="fas fa-envelope" />
                    <p>Messages</p>
                  </Link>
                </li>
                <li className={`nav-item ${urlActuelle === '/user/notifications' ? 'active' : ''}`}>
                  <Link to="/user/notifications">
                    <i className="fas fa-bell" />
                    <p>Notifications</p>
                  </Link>
                </li>
                <li className={`nav-item ${urlActuelle === '/parametres-du-stockiste' ? 'active' : ''}`}>
                  <Link to={`/parametres-du-stockiste`}>
                ...
                {userData?.shop &&
                  <>
                    ...
                    <li className="nav-item">
                      <Link to={`/boutique/${userData?.shop.slug}`}>
                    ...
                    <li className="nav-item">
                      <Link to={`/`}>
                        {/* <i className="fas fa-store" /> */}
                        <p className='text-warning'>Retour</p>
                      </Link>
                    </li>
                  </>
                }
              ...
              <div className="page-inner py-5">
                <div className="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                  ...
                  <div className="ml-md-auto py-2 py-md-0">
                    {userData?.shop &&
                      <Link to={`/boutique/${userData?.shop.slug}`} className="btn btn-primary">
